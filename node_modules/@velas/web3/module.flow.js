 ...
 */
     ...
     */
    getVelasAccountsByOwnerKey(publicKey: string): Promise<any>;

    /**
     * Fetch the accounts for the specified operational key
     */
    getVelasAccountsByOperationalKey(publicKey: string): Promise<any>;
 ...
 */
    ...
    getConfirmedBlocksWithLimit(slot: number, limit: number): Promise<any>;
   ...
   */
  declare export var StakeAuthorizationLayout: any;
